...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_exam'])) {
    ...
    if (empty($date_err) && empty($time_err) && empty($error_msg)) {
        if (createExam($subject_id, $exam_date, $start_time, $end_time, $venue, $notes)) {
            $success_msg = "Exam added successfully!";
        } else {
            $error_msg = "Failed to add exam. Please try again.";
        }
    }
}
?>
    ...
    <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
        <div class="card-body p-4">
            ...
            <div class="mb-4 text-center">
                <div class="bg-info bg-opacity-10 text-info rounded-circle d-inline-flex align-items-center justify-content-center mb-3" style="width: 54px; height: 54px;">
                    <i class="fa-solid fa-file-signature fa-xl"></i>
                </div>
                <h5 class="fw-semibold mb-0">New Exam</h5>
            </div>
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="exam_date" class="form-control <?php echo $date_err ? 'is-invalid' : '' ?> bg-light border-0 py-2" id="exam_date">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="venue" class="form-control bg-light border-0 py-2" id="venue" placeholder="e.g. Hall A, Room 204">
                </div>
                ...
                <div class="row g-3 mb-3">
                    <div class="col-6">
                        ...
                        <input type="time" name="start_time" class="form-control <?php echo $time_err ? 'is-invalid' : '' ?> bg-light border-0 py-2" id="start_time">
                        <div class="invalid-feedback">
                            <?php echo $time_err ?>
                        </div>
                    </div>
                    <div class="col-6">
                        ...
                        <input type="time" name="end_time" class="form-control <?php echo $time_err ? 'is-invalid' : '' ?> bg-light border-0 py-2" id="end_time">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        ...
                        name="notes"
                        rows="3"
                        placeholder="e.g. Bring student ID and calculator"></textarea>
                </div>
                ...
                <div class="d-flex align-items-center justify-content-end gap-2">
                    ...
                    <button type="submit" name="add_exam" class="btn btn-info text-white px-4 shadow-sm">
                        <i class="fa-solid fa-plus me-2"></i>Add exam
                    </button>
                </div>
